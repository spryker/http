...
class HttpConfig extends AbstractBundleConfig
{
    ...
    {
        return $this->get(HttpConstants::YVES_HTTP_PORT, static::DEFAULT_REQUEST_HTTP_PORT);
    }
    ...
    {
        return $this->get(HttpConstants::YVES_HTTPS_PORT, static::DEFAULT_REQUEST_HTTPS_PORT);
    }
    ...
    {
        return $this->get(HttpConstants::YVES_HTTP_CACHE_CONTROL_CONFIG, []);
    }
}
